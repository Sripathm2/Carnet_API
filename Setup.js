...
const insert_stmt = 'INSERT INTO Users (userName, password, email , securityQuestion, securityAnswer, name, notebooks) VALUES (\'testUsername\',\'passwords\', \'test@test.com\', \'what my name?\', \'test answer\', \'test test\', \'notebooks\')';
